...
class CriarTarefa(GroupRequiredMixin, LoginRequiredMixin, View):
...
class EditarTarefa(GroupRequiredMixin, LoginRequiredMixin, View):
    group_required = (u"SGCE", u"Inspetores Gerais", u"Supervisores")
...
class ExcluirTarefa(GroupRequiredMixin, LoginRequiredMixin, View):
