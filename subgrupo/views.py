...
class CriarSubGrupo(GroupRequiredMixin, LoginRequiredMixin, View):
...
class VisualizarSubGrupo(GroupRequiredMixin, LoginRequiredMixin, ListView):
...
class MostraSubGrupo(GroupRequiredMixin, LoginRequiredMixin, View):
    group_required = (u"Auditores", u"SGCE", u"Inspetores Gerais", u"Supervisores")
